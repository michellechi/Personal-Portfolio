          ...
          >
            ...
            <div
              ...
              <div className="qualification__data">
                ...
                <div>
                  <h3 className="qualification__title">Data and Analytics Intern</h3>
                  <span className="qualification__subtitle">California Department of Public Health, Epidemiological Research Section</span>
                  <div className="qualification__calendar">
                    <i className="uil uil-calendar-alt"></i> Starting February 2025
                  </div>
                </div>
              </div>
